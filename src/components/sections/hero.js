...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Sachin Devangan.</h2>;
  ...
  const four = (
    <>
      <p>
        ...
        my skills in Java, React, Node.js, TypeScript, and AWS to meet modern development
        challenges.
      </p>
    </>
  );
  const five = (
    <a className="email-link" href={resume} target="_blank" rel="noreferrer">
      Check out my resume!
    </a>
  );
